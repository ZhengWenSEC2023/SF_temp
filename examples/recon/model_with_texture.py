...
class Model(nn.Module):
    def __init__(self, filename_obj, args):
        ...
        self.encoder_color = EncoderColor(im_size=args.image_size)
    ...
    def reconstruct(self, images, save_path=None, fill_back=False):
        ...
        # srf.save_obj(save_path, vertices[0], faces[0], textures[0])
    ...
    def predict_multiview(self, image_a, image_b, viewpoint_a, viewpoint_b):
        ...
        vertices, faces = self.decoder(self.encoder(images))
        colors = self.encoder_color(images)
        ...
        silhouettes = self.renderer(vertices, faces, textures)
