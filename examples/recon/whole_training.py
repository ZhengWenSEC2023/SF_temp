...
import whole_datasets as datasets
import models
import imageio
import time
import os
...
CLASS_IDS_ALL = (
        '02747177,02773838,02801938,02808440,02818832,02834778,02843684,02858304,' +
        '02871439,02876657,02880940,02924116,02942699,02946921,02954340,02992529,' +
        '03046257,03085013,03207941,03261776,03325088,03337140,03467517,03513137,' +
        '03593526,03624134,03642806,03710193,03759954,03761084,03790512,03797390,' +
        '03928116,03938244,03948459,03991062,04004475,04074963,04099429,04225987,' +
        '04330267,04460130,04468005,04554684,02691156,02828884,02933112,02958343,' +
        '03001627,03211117,03636649,03691459,04090263,04256520,04379243,04401088,04530566'
)
