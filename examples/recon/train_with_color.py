...
import torch
import numpy as np
from losses import multiview_iou_loss_color as multiview_iou_loss
from utils import AverageMeter, img_cvt
import soft_renderer as sr
import soft_renderer.functional as srf
import datasets
import model_with_texture as models
import imageio
import time
import os

CLASS_IDS_ALL = ('02691156,02828884')
...
def train():
    ...
    for i in range(start_iter, args.num_iterations + 1):
        ...
        if i % args.demo_freq == 0:
            ...
            srf.save_obj(demo_path, demo_v[0], demo_f[0], demo_t[0])
