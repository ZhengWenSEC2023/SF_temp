...
def projection(vertices, P, dist_coeffs, orig_size):
    ...
    shape transformation like panoroma.

    P: 3x4 projection matrix
    dist_coeffs: vector of distortion coefficients
    orig_size: original size of image captured by the camera

    Firstly supplement the [BS, # of vertices, 3] -> [BS, # of vertices, 4], add a column of 1
    Then multiple the vertices by Projection matrix (P^T) by batch
    Finally calculate the 3D vertices in another view.
    '''
